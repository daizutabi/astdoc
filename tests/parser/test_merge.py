...
def test_merge_parameters_type_annotations():
    from astdoc.parser import merge_parameters
...
def test_merge_returns_type_annotations():
    from astdoc.parser import merge_returns
...
def test_merge_raises():
    from astdoc.parser import merge_raises
...
def test_merge_attribute_module():
    from astdoc.parser import merge_attributes
