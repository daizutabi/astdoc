...
from astdoc.node import iter_module_members, parse_module
from astdoc.object import get_object
from astdoc.utils import list_exported_names


def test_parse_module_astdoc():
    assert not parse_module("astdoc")


def test_iter_module_members_astdoc():
    assert not list(iter_module_members("astdoc"))
